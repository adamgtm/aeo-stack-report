...
**Updated:** 2026-06-14, refreshed weekly. This repo is the agent-ready mirror. Adam's GTM Report website is the source of truth.
...
- **Sourced and documented, so you can check the work.** Every claim traces to a primary reference: the funding post, the launch, the analyst note. All 250 sources live in `sources/sources.md` with content and external links.
...
- **`sources/sources.md`**: 250 external references, each with the claim it supports.
